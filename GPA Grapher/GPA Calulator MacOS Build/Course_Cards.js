...
var Path_To_Profile_Data = localStorage.getItem('Profile_Path');
var Course_Bank_Data_Stream = fs.readFileSync(Path_To_Profile_Data+'Course_Bank.json');
...
var Path_JSON_Prefix = String(localStorage.getItem('Path_Prefix'));
var Path_To_Profile_Data = localStorage.getItem('Profile_Path');
fs.writeFile(Path_To_Profile_Data+'Course_Bank.json',Course_Bank_Data_Output_Stream,Completed);
...
// Background_Mode();
  ...
  var Path_To_Profile_Data =  "/" + String(Partitioned_Path[1]) + "/" + String(Partitioned_Path[2]) + "/" + String(Partitioned_Path[3]) + "/Profile_Data/";

//Beta testing line
  // var Path_To_Profile_Data = Path_Name;

  localStorage.setItem('Profile_Path',Path_To_Profile_Data);




  var Path_To_Profile_Data = localStorage.getItem('Profile_Path');
  var Profile_Icon_URL = "'" + Path_To_Profile_Data + "Profile_Image.png'"
  ...
  var Path_JSON_Prefix = String(localStorage.getItem('Path_Prefix'));
  var Path_To_Profile_Data = localStorage.getItem('Profile_Path');
  var Profile_Data_Stream = fs.readFileSync(Path_To_Profile_Data+'Main_Profile.json');
...
var Path_To_Profile_Data = localStorage.getItem('Profile_Path');
var Course_Bank_Read_Stream = fs.readFileSync(Path_To_Profile_Data+'Course_Bank.json');
...
document.getElementById("Shader").style.background = "rgba(240,240,240,1)";
